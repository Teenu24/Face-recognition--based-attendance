...
message = tk.Label(window, text="Face-Recognition-Based-Attendance-Management-System" ,bg="pink"  ,fg="white"  ,width=50  ,height=3,font=('times', 30, 'italic bold underline')) 
...
lbl3 = tk.Label(window, text="Notification : ",width=20  ,fg="red"  ,bg="white"  ,height=2 ,font=('times', 15, ' bold underline ')) 
lbl3.place(x=400, y=400)

message = tk.Label(window, text="" ,bg="white"  ,fg="red"  ,width=30  ,height=2, activebackground = "white" ,font=('times', 15, ' bold ')) 
message.place(x=700, y=400)

lbl3 = tk.Label(window, text="Attendance : ",width=20  ,fg="red"  ,bg="white"  ,height=2 ,font=('times', 15, ' bold  underline')) 
lbl3.place(x=400, y=650)


message2 = tk.Label(window, text="" ,fg="red"   ,bg="white",activeforeground = "pink",width=30  ,height=2  ,font=('times', 15, ' bold ')) 
...
def TakeImages():        
    Id=(txt.get())
    name=(txt2.get())
    if(Id.is_alnum() and name.isalpha()):
...
clearButton = tk.Button(window, text="Clear", command=clear  ,fg="red"  ,bg="white"  ,width=20  ,height=2 ,activebackground = "Red" ,font=('times', 15, ' bold '))
clearButton.place(x=950, y=200)
clearButton2 = tk.Button(window, text="Clear", command=clear2  ,fg="red"  ,bg="white"  ,width=20  ,height=2, activebackground = "Red" ,font=('times', 15, ' bold '))
